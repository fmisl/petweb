            ...
            <div className="modal-body">
              ...
              <div style={{position:"relative",width:"750px",height:"100%", background:"#383C41", border:"0px red solid"}}>
                <div style={{...styleDiv, ...{top:"0", left:"0"}}} >
                  ...
                  {currentJPGURL_head !== "" && <img width={'400px'} style={{transform:`${fileList[listID]?.InputAffineX0 < 0 ? "scaleX(-1)":"scaleX(1)"}`, border:"1px white solid", boxSizing:"border-box"}} 
                ...
                <div style={{...styleDiv, ...{top:"", left:"50%"}}} >
                  {/* {currentJPGURL_head !== "" && <img height={'100%'} width={'300px'} style={{border:"1px white solid", boxSizing:"border-box"}}  */}
                  {currentJPGURL_head !== "" && <img width={'400px'} style={{transform:`${fileList[listID]?.InputAffineY1 < 0 ? "scaleX(-1)":"scaleX(1)"}`, border:"1px white solid", boxSizing:"border-box"}} 
                  ...
                  {/* {currentJPGURL_head !== "" && <img height={'100%'} width={'300px'} style={{border:"1px white solid", boxSizing:"border-box"}}  */}
                  {currentJPGURL_head !== "" && <img width={'400px'} style={{transform:`${fileList[listID]?.InputAffineY1 < 0 ? "scaleY(-1)":"scaleY(1)"}`, border:"1px white solid", boxSizing:"border-box"}} 
                ...
                {fileList[listID] && <div style={{position:"absolute", border:"0px red solid", top:"50%", left:"23%", height:"45%", userSelect:"none", display:"flex", justifyContent:"space-between", flexDirection:'column'}}><div>P</div><div>A</div></div>}
              </div>
            </div>
